...
<template>
  <div v-if="account">
    <!-- address -->
    <div class="#saved px-4 pt-3 pb-4 rounded mb-4 shadow">
      <div class="flex items-center">
        <!-- img -->
        <div class="inline-flex relative w-11 h-11 rounded-md">
          <div
            class="w-11 h-11 absolute rounded-md opacity-10 #sav1"
          ></div>
          <div
    ...
    <div class="#saved px-4 pt-3 pb-4 rounded mb-4 shadow">
      <div class="flex justify-between">
        ...
        <div class="flex justify-end mb-4 pr-5">
            <label
              for="send"
              class="btn  #sav1 btn-sm mr-2"
              @click="dialog.open('send', {}, updateEvent)"
              >{{ $t('account.btn_send') }}</label
            >
            <label
              for="transfer"
              class="btn  #sav1 btn-sm"
              @click="
                dialog.open(
                  'transfer',
                  {
        ...
        <div class="mt-4 md:!col-span-2 md:!mt-0 md:!ml-4">          
          ...
          <div class="">
            ...
            >
              ...
              <div
                class="text-xs truncate relative py-1 px-3 rounded-full w-fit  #saved dark:invert mr-2"
              >
                <span
                  class="inset-x-0 inset-y-0 opacity-10 absolute #sav1 dark:invert text-sm"
                ></span>
            ...
            >
              ...
              >
                ...
                />
                <div
                  class="absolute top-0 bottom-0 left-0 right-0 bg-grey-950 opacity-20"
                ></div>
              </div>
              <div class="flex-1">
                <div class="text-sm font-semibold">
            ...
            <div class="flex items-center px-4">
              ...
              <div
                class="text-xs truncate relative py-1 px-3 rounded-full w-fit  #saved dark:invert mr-2"
              >
                <span class="inset-x-0 inset-y-0 opacity-10 absolute #sav1 dark:invert"></span>
                ${{format.tokenValue({
                      amount: String(unbondingTotal),
                      denom: stakingStore.params.bond_denom,
                    })
        ...
        <table class="table w-full text-sm table-zebra">
          ...
          <tbody class="text-sm">
            ...
            <tr v-for="(v, index) in delegations" :key="index">
              <td class="text-caption  #saved py-3">
                <RouterLink
    ...
    <div
      class="#saved px-4 pt-3 pb-4 rounded mb-4 shadow"
      ...
      <div class="overflow-x-auto">
        <table class="table text-sm w-full">
          ...
          <tbody class="text-sm" v-for="(v, index) in unbonding" :key="index">
              <tr>
                <td class="text-caption  #saved py-3 bg-slate-200" colspan="10">
                  <RouterLink
          ...
          <tbody class="text-sm">
            ...
            <tr v-for="(v, index) in txs" :key="index">
              <td class="text-sm py-3">
                <RouterLink :to="`/${chain}/block/${v.height}`" class=" #saved dark:invert">{{
                  v.height
                }}</RouterLink>
              </td>
              <td class="truncate py-3" style="max-width: 200px">
                <RouterLink :to="`/${chain}/tx/${v.txhash}`" class=" #saved dark:invert">
                  {{ v.txhash }}
                </RouterLink>
              </td>
              <td class="flex items-center py-3">
                ...
                <Icon
                  v-if="v.code === 0"
                  icon="mdi-check"
                  class="text-base-content text-lg"
                />
