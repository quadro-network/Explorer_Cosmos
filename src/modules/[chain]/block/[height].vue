...
<template>
  <div>
    <div v-if="isFutureBlock" class="text-center">
      <div v-if="remainingBlocks > 0">
        ...
        <div class="pt-10 flex justify-center">
          <table class="table w-max rounded-lg bg-customBlack">
            <tbody>
    ...
    <div v-else>
      <div class="bg-customBlack px-4 pt-3 pb-4 rounded mb-4 shadow ">
      ...
      <div class="bg-customBlack px-4 pt-3 pb-4 rounded shadow">
