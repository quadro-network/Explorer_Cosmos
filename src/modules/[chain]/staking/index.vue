...
const change24Color = (entry: { consensus_pubkey: Key; tokens: string }) => {
    if (!entry) return '';
    const v = change24(entry);
    if (v > 0) return 'text-base-content';
...
<template>
<div>
    <div class="#saved bg-customDark border rounded-lg grid sm:grid-cols-1 md:grid-cols-4 p-4 text-customGreen" >    
        <div class="flex ">
            <span>
        ...
        <div class="flex">
            <span>
                <div class="relative w-9 h-9 rounded overflow-hidden flex items-center justify-center mr-2">
                    <Icon class=" #saved" icon="mdi:lock-open-outline" size="32" />
                    <div class="absolute top-0 left-0 bottom-0 right-0 opacity-20 #sav1"></div>
                </div>
            </span>
            <span>
        ...
        <div class="flex items-center justify-between py-1">
            <div class="tabs tabs-boxed bg-transparent">
                <a
                    ...
                    :class="{ 'tab-act': tab === 'featured' }"
                    @click="tab = 'featured'"
                    >{{ $t('staking.popular') }}</a
                >
                <a
                    class="tab text-gray-400"
                    :class="{ 'tab-act': tab === 'active' }"
                    @click="tab = 'active'"
                    >{{ $t('staking.active') }}</a
                >
                <a
                    class="tab text-gray-400"
                    :class="{ 'tab-act': tab === 'inactive' }"
                    @click="tab = 'inactive'"
        ...
        <div class="#saved px-4 pt-3 pb-4 rounded shadow">
            <div class="overflow-x-auto">
                <table class="table staking-table w-full">
                    <thead class=" bg-customDark border text-customGreen">
                        <tr>
                            <th
                                scope="col"
                                class="uppercase"
                    ...
                    <tbody>
                        <tr
                            ...
                            class=" hover:bg-customDark dark:hover:bg-[#141414]"
                        >
                            <!-- 👉 rank -->
                            <td>
                                <div
                            ...
                            <td>
                                ...
                                >
                                    ...
                                    <div class="flex flex-col">
                                        <span class="text-sm  #saved  whitespace-nowrap overflow-hidden">
                                            <RouterLink
                                                :to="{
                            ...
                            <td style="display: none" class="text-center">
                                ...
                                <label
                                    v-else
                                    for="delegate"
                                    class="btn btn-xs  #sav1 rounded-sm capitalize"
                                    @click="
